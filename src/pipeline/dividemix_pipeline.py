...
if __name__ == "__main__":
    ...
    save_evaluation(report, test_file, data_save_path, f'dividemix_{noise_ratio}_fixed')
    add_predictions_to_data(test_data, test_file, data_save_path, test_preds, f'dividemix_{noise_ratio}_fixed')